-- SQL Import: Thêm nội dung trang tĩnh còn thiếu vào Supabase
-- Chạy trong Supabase Dashboard > SQL Editor > New query

-- Kiểm tra bảng static_pages đã tồn tại chưa
-- Nếu chưa có, tạo bảng (bỏ comment nếu cần):
/*
...
-- Ghi chú: 
-- - app_guide.apk_link và app_guide.testflight_link đang là NULL
-- - Cần cập nhật thủ công trong Admin hoặc chạy UPDATE sau khi có link
