...
Nếu dùng R2, Google Sheets, OPhim custom URL thì thêm (giá trị lấy từ Cloudflare/Google — xem `docs/r2/README.md`, `docs/google-sheets/README.md`):
...
7. (Tùy chọn) Gắn domain, R2, Google Sheets, Comments, Capacitor.
